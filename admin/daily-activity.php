...
<body class="light-mode page-daily-activity page-daily-activity-reports page-activity-registry<?= $openRecord !== null ? ' activity-registry-modal-open' : '' ?>"
...
<div id="activity-modal-overlay" class="reports-modal-overlay<?= $openRecord !== null ? ' is-open' : '' ?>"
    ...
    <div class="reports-modal" id="activity-modal" role="dialog" aria-modal="true" aria-labelledby="activity-modal-title">
        ...
        <div class="reports-modal__content">
            <main class="reports-modal__body-scroll" id="activity-modal-main" aria-label="Daily activity report details">
                <div class="reports-modal-form">
                    <div id="activity-modal-view"
                        ...
                        <?php $activityHistoryCopy = admin_activity_registry_history_section_copy(false); ?>
