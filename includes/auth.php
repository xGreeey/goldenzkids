...
/** Normalize stored role values to guard (0), admin (1), or superadmin (2). */
...
function auth_login_redirect_url(int $role): string
{
    ...
    return match ($role) {
        ...
        AUTH_ROLE_GUARD => app_url('guard/index.php'),
...
>>>>>>> 6fc421ce8c5654cf50392cff8ebc3f605db6ff27
