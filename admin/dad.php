...
$adminNavActive = 'dad';
$dadPage = admin_attendance_page_path();
...
<body class="light-mode page-daily-detail"
...
<?php require __DIR__ . '/../includes/admin_sidebar.php'; ?>
    ...
    <main class="app-main">
        <header class="page-header page-header--inline">
            <h1 class="page-title"><?= e(ADMIN_ATTENDANCE_MODULE_LABEL) ?> <span class="page-title__code mono"><?= e(ADMIN_ATTENDANCE_REF_CODE) ?></span></h1>
            ...
            <section class="reports-panel" aria-label="<?= e(ADMIN_ATTENDANCE_MODULE_LABEL) ?> registry">
                ...
                <div class="reports-panel__body">
                    <div class="reports-registry" role="region" aria-label="<?= e(ADMIN_ATTENDANCE_REF_CODE) ?> registry table">
                        <div class="reports-table-head-wrap" id="daily-table-head-wrap">
                        ...
                        <div class="reports-table-body-wrap" id="daily-table-body-wrap" tabindex="0">
                    ...
                    <div class="reports-modal-form__blocks">
                        <div id="daily-panel-view" class="reports-modal-panel reports-modal-form__section reports-modal-form__section--wide<?= $drawerMode === 'view' ? ' is-active' : '' ?>"<?= $drawerMode === 'view' ? '' : ' hidden' ?>>
                            <header class="reports-modal-form__section-header">
                                <h3 class="reports-modal-form__section-title"><?= e(ADMIN_ATTENDANCE_MODULE_LABEL) ?> details</h3>
                            </header>
                            <div class="reports-detail-groups reports-detail-groups--modal" id="daily-view-details">
                                <?php if ($openRecord): ?>
